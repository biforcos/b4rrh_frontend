export const employeeTexts = {
  ...
  timelineSubtitle: 'Vista agregada de eventos historicos del empleado por tracks.',
  timelineTrackCodeLabel: 'Track',
  timelineOpenPeriodLabel: 'actual',
  timelineCurrentBadgeLabel: 'Actual',
