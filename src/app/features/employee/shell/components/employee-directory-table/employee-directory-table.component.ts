...
import {
  StatusChipComponent,
  StatusChipVariant,
} from '../../../../../shared/ui/status-chip/status-chip.component';
...
@Component({
          ...
          @if (loading()) {
            @for (row of skeletonRows; track $index) {
              <tr class="dir-table__skeleton-row">
                <td class="dir-table__td">
                  <div class="dir-table__skeleton dir-table__skeleton--avatar"></div>
                </td>
                <td class="dir-table__td">
                  <div class="dir-table__skeleton dir-table__skeleton--name"></div>
                </td>
                <td class="dir-table__td">
                  <div class="dir-table__skeleton dir-table__skeleton--sm"></div>
                </td>
                <td class="dir-table__td">
                  <div class="dir-table__skeleton dir-table__skeleton--sm"></div>
                </td>
                <td class="dir-table__td">
                  <div class="dir-table__skeleton dir-table__skeleton--chip"></div>
                </td>
            ...
            @for (employee of items(); track employee.employeeNumber) {
              <tr
                ...
                [class.dir-table__row--inactive]="
                  getStatusVariant(employee.statusLabel) === 'inactive'
                "
                role="button"
                tabindex="0"
              ...
              >
                ...
                <td class="dir-table__td">
                  <span class="dir-table__matricula"
                    >{{ employee.ruleSystemCode }} · {{ employee.employeeNumber }}</span
                  >
                </td>
                <td class="dir-table__td">
                  <app-status-chip
  ...
  styles: [
    `
      ...
      .dir-table__row:last-child {
        border-bottom: none;
      }
      .dir-table__row:hover {
        background: var(--surface-hover);
      }
      .dir-table__row--inactive {
        opacity: 0.55;
      }
      .dir-table__row--inactive:hover {
        opacity: 0.75;
      }
      .dir-table__td {
        padding: 11px 16px;
      ...
      .dir-table__td--avatar {
        width: 52px;
        padding-right: 0;
      }
      .dir-table__td--actions {
        width: 40px;
        text-align: right;
      }
      .dir-table__name {
      ...
      .dir-table__skeleton--avatar {
        width: 36px;
        height: 36px;
        border-radius: 50%;
      }
      .dir-table__skeleton--name {
        width: 160px;
        height: 14px;
      }
      .dir-table__skeleton--sm {
        width: 80px;
        height: 12px;
      }
      .dir-table__skeleton--chip {
        width: 60px;
        height: 22px;
        border-radius: 20px;
      }
