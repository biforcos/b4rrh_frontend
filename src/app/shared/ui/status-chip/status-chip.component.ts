...
@Component({
  ...
  styles: [`
    ...
    .status-chip--active .status-chip__dot { background: var(--success-text); }
    .status-chip--inactive {
      background: var(--neutral-bg);
      color: var(--neutral-text);
      border-color: rgba(100, 116, 139, 0.2);
    }
    .status-chip--inactive .status-chip__dot { background: var(--neutral-text); }
    .status-chip--warning {
      background: var(--warning-bg);
      color: var(--warning-text);
      border-color: rgba(245, 158, 11, 0.2);
    }
    .status-chip--warning .status-chip__dot { background: var(--warning-text); }
    .status-chip--error {
      background: var(--error-bg);
      color: var(--error-text);
      border-color: rgba(239, 68, 68, 0.2);
    }
    .status-chip--error .status-chip__dot { background: var(--error-text); }
    .status-chip__dot {
      width: 6px;
      height: 6px;
      border-radius: 50%;
